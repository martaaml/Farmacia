DROP DATABASE IF EXISTS mistiendas;
CREATE DATABASE mistiendas;
USE mistiendas;
-- Creamos las tablas
...
FOREIGN KEY (tienda) REFERENCES tiendas (cod)
ON UPDATE CASCADE,
...
INSERT INTO `productos` (`cod`, `nombre`, `nombre_corto`, `descripcion`, `PVP`, `familia`)
VALUES
...
SiA6 Si\r\nB5 SiB6 Si\r\nSobres C5 (162 x 229 mm) SiSobres C6 (114 x 162 mm) Si', '99.90',
'IMPRES'),
...
('PBELLI810323', NULL, 'Packard Bell I8103 23 I3-550 4G 640GB NVIDIAG210',
'Características:\r\n\r\nCPU CHIPSET\r\n\r\nProcesador : Ci3-550\r\nNorthBridge : Intel
...
('SMSN150101LD', NULL, 'Samsung N150 10.1LED N450 1GB 250GB BAT6 BT W7 R',
